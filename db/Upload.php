        ...
        if ($fileExtension === 'csv') {
            ...
            if (($handle = fopen($file, 'r')) !== false) {
                ...
                while (($data = fgetcsv($handle)) !== false) {
                    ...
                    $time = strtotime($column1);
                    $newformat = date('Y-m-d',$time);   
                    // echo $newformat; 
                    // Create the INSERT query
                    $query = "INSERT INTO fxrate ( date ,currency, open , high, low,close,adj_close ) VALUES ('$newformat','$currency', '$column2','$column3','$column4','$column5','$column6')";
